...
import com.springboot.case_study.service.MyUserService;
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		.csrf(csrf->csrf.disable())
			.authorizeHttpRequests((authorize) -> authorize
				...
				.requestMatchers("/api/patient/add/{userId}/{mhId}").hasAuthority("PATIENT")
				.requestMatchers("/doctor/patient/appointment/{docId}/{patId}").permitAll()
				.requestMatchers("patients/all/{docId}").hasAnyAuthority("DOCTOR")
